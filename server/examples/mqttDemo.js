...
class MqttDemo {
  ...
  async connect() {
    console.log(`[Demo] Connecting to MQTT broker ${this.config.host}:${this.config.port}...`);
...
async function runDemo() {
  ...
  try {
    ...
    console.log('\\n=== Demo Complete ===');
    console.log('Keep this script running to see ongoing observation notifications.');
